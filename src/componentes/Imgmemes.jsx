        ...
        <div id="exportar" style={{display: 'inline-block'}}>
          {imgmeme && (
            <figure className="contenedor-meme">
              <p className="texto-meme" style={{fontSize: `${fontSize}px`,color: `rgb(${red}, ${green}, ${blue})`,  transform: `translate(${ejex}px, ${ejey}px)`}}>
                {textmeme}
              </p>
              <p className="texto-meme2" style={{fontSize: `${fontSize}px`,color: `rgb(${red}, ${green}, ${blue})`, transform: `translate(${ejex2}px, ${ejey2}px)`}}>
                {textmeme2}
              </p>
